...
*/
package trace // import "github.com/nycu-ucr/net/trace"
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/nycu-ucr/net/trace in your binary, trying to maintain separate state. This may " +
...
var contextKey = contextKeyT("github.com/nycu-ucr/net/trace.Trace")
